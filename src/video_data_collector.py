...
class VideoDataCollector:
            ...
            try:
                ...
                for li in soup.select('li'):
                    ...
                    if anchor and 'title' in anchor.attrs:
                        ...
                        logging.warning(f"No valid link or title found for date {date}. Skipping entry.")
                ...
                logging.warning(f"Error fetching data for {date} (Attempt {attempt + 1}/{retries}): {e}")
    ...
    def get_video_content(self, video_url: str) -> str:
        ...
        try:
            ...
            logging.error(f"Error fetching content for {video_url}: {e}")
            return "内容未找到"
